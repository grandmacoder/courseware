...
function WPCW_showPage_Dashboard_load()
{
	...
	$summaryPageURL = admin_url('admin.php?page=WPCW_wp_courseware');
	...
	$page->showPageHeader(__('My Training Courses', 'wp-courseware'), '75%', WPCW_icon_getPageIconURL());
	...
	if ($courses || $searchString)
	{
		...
		<p class="search-box">
			...
			<input type="hidden" name="page" value="WPCW_wp_courseware" />
		</p>
		</form>
		<?php
